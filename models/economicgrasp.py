...
from models.modules_economicgrasp import GraspableNet, ViewNet, Cylinder_Grouping_Global_Interaction, Grasp_Head_Local_Interaction, Sphere_Grouping_Global_Interaction
...
class economicgrasp(nn.Module):
    def __init__(self, cylinder_radius=0.05, seed_feat_dim=512, is_training=True, voxel_size=0.005, attn_layer=False, is_refine=False):
        ...
        # View Selection
        self.view = ViewNet(
            self.num_view, seed_feature_dim=self.seed_feature_dim, is_training=self.is_training, is_refine=is_refine)
    ...
    def forward(self, end_points):
        ...
        group_features = self.cy_group(seed_xyz_graspable.contiguous(),
                                       ...
                                       grasp_top_views_rot)
        end_points['group_features'] = group_features  # [B, 256, 1024] for CFM
